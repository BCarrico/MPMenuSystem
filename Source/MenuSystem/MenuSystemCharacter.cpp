...
void AMenuSystemCharacter::JoinGameSession()
{
	...
	if (GEngine)
	{
		GEngine->AddOnScreenDebugMessage(-1, 15.f, FColor::Cyan, FString::Printf(TEXT("Trying to find game session")));
	}
...
void AMenuSystemCharacter::OnCreateSessionComplete(FName SessionName, bool bWasSuccessful)
{
	if (bWasSuccessful)
	{
		...
		{
			World->ServerTravel(FString("/Game/ThirdPerson/Maps/NewLevelLobby?listen")); // Travel to lobby level and open as a listen server
		}
	}
	else
	{
